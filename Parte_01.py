...
class PDFSelectorApp:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("NovaPDF_AR.vr.0001")
    ...
    def _crear_ventana_progreso(self, texto="Procesando...", max_val=100):
        ...
        self.progreso_win.title("Cargando PDF...")# Principal al abrir PDF
    ...
    def crear_preview_hilo(self):
        if not self.doc:
            return
        self._crear_ventana_progreso(texto="Cargando páginas, por favor espere...", max_val=self.num_paginas)
